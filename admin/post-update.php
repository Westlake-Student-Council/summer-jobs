...
require "../classes/PostUpdate.php";
$obj = new PostUpdate($post_id);
$obj->loadCurrentPostDetails();

// Define variables and initialize with empty values
$business_name = $obj->getBusinessName();
$position_name = $obj->getPositionName();
$pay = $obj->getPay();
$min_age = $obj->getMinAge();
$job_application_link = $obj->getJobApplicationLink();
$indeed_link = $obj->getIndeedLink();
$location = $obj->getLocation();
$is_visible = $obj->getIsVisible();
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                            ...
                            <div class="form-group <?php echo (!empty($is_visible_error)) ? 'has-error' : ''; ?>">
                                ...
                                <input type="radio" name="is_visible" value="0" <?php if($is_visible==0){echo "checked";}?>> Not yet.&nbsp;&nbsp;
                                <input type="radio" name="is_visible" value="1" <?php if($is_visible==1){echo "checked";}?>> Yes!
